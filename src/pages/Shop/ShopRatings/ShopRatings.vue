...
import Star from '../../../components/Star/StarShow.vue'
// 引入第三方滑动库
      ...
      return ratings.filter(rating => {
        ...
        /* 
          条件1： selectType： 0/1/2
                  ...
                  (1)首先，如果selectTYpe =2，则不用看ratetype
                  (2)以上不成立，则需要看 selectType === rateType
                   
                   两个条件是或的关系： selectType === 2 || selectType === rateType
                  
          条件2： onlyShowText: true/false 和 text中是否有值

                  (1)onlyShowText: false时，不用看text
                  (2)onlyShowText: true时，要看text的length>0

                  因此： !onlyShowText || text.length>0
        */
      //  以上两个条件都要满足，利用 &&
