<template>
  <div class="shop-header">
      <!-- 头部返回 -->
      <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}" v-if="info.avatar">
          <a class="back" @click='$router.back()'>
              <i class="iconfont icon-arrow_left"></i>
          </a>
      </nav>

      <div class="shop-content" @click="toggleShopShow" v-if="info.avatar">
          <img class="content-img"  :src="info.avatar">
      ...
      <!-- 妙处！！利用v-if控制在没有真正的数据到来之前，不存在。只有有数据才存在 -->
